...
<div class="centered-container">
    ...
    <div class="form">
      <md-field>
        <label>E-mail</label>
        <md-input type="email" name="email" v-model="email" placeholder="Email" autofocus></md-input>
      </md-field>

      <md-field md-has-password>
        <label>Password</label>
        <md-input name="password" v-model="password" placeholder="Password" type="password"></md-input>
      </md-field>
    </div>
